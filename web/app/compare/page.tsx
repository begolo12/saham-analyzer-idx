...
export default function ComparePage() {
  return (
    <div className="app-shell min-h-screen bg-background">
      <TopHeader />
      <main className="page-main container space-y-5">
        <div className="mobile-topbar md:hidden">
          <div className="mobile-topbar__inner">
            <div className="min-w-0 flex-1">
              <div className="mobile-topbar__title flex items-center gap-2 text-foreground">
        ...
        <div className="hidden items-center gap-2 md:flex mb-2">
          <Link href="/" aria-label="Kembali ke Beranda">
            <Button variant="ghost" size="sm" className="min-h-9 bg-[hsl(var(--primary))] text-white rounded-lg px-4 py-2 font-medium !bg-secondary !text-secondary-foreground !shadow-none hover:!shadow-sm">
        ...
        <div className="page-hero-card p-4 md:hidden bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-xl">
        ...
        <div className="page-section-heading mt-2">
          <div>
            <div className="page-section-title text-foreground">Bandingkan dan putuskan</div>
