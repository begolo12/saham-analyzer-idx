...
| 9 | H6 | 🔴 HIGH | Zero rate limiting on all 16 API routes | All `api/*/route.ts` | 🔴 | Add rate-limit middleware |
| 10 | M2 | 🔴 MED | 7 type bugs revealed by removing `any` | `stock/[ticker]/page.tsx:360,370-385` | 🔴 | Fix null guards + missing fields |
| 11 | M3 | 🔴 MED | No AbortController in data fetches | `page.tsx:88` `portfolio/page.tsx:145` | 🔴 | Add AbortController pattern |
| 12 | M4 | 🔴 MED | Missing timeouts on Yahoo fetches | `compare/route.ts` `screener/fundamental/route.ts` | 🔴 | Add 8s AbortController |
...
| 20 | M7 | 🔴 MED | 9x `confirm()` — inconsistent with iOS UI | `portfolio/page.tsx` | 🔴 | Use app modal component |
...
| 24 | M15 | 🔴 MED | Cache typed as `Map<string, { data: any }>` | `api/screener/route.ts` | 🔴 | Add proper generics |
...
| 28 | M11 | 🔴 MED | 3 React hooks warnings (useMemo deps) | `stock/page.tsx:140` `watchlist/page.tsx:290` | 🔴 | Fix deps arrays |
| 29 | L1 | 🔴 LOW | Only 1 test file (24 tests) | `portfolio.test.ts` only | 🔴 | Add tests for lib/, api/ |
| 30 | L2 | 🔴 LOW | No Python CI/testing | `.github/workflows/deploy.yml` | 🟢 2026-06-26 | Added pytest step + pyproject.toml |
...
| 33 | L5 | 🔴 LOW | try-catch gap on param parsing | `api/realtime/route.ts:16-37` | 🔴 | Wrap in try-catch |
